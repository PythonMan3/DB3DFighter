...
class DB3DFighterVersus:
    ...
    def init(self):
        ...
        # タイトル初期化
        self.title = title.GameTitle(self.window, self.width, self.height, self.music)
        # キャラ選択初期化
        self.select_character = select_character.SelectChara(self.window, self.width, self.height, self.music)
