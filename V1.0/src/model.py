...
MODEL_FILE_NAME = "data/DB_ALL_models.h5"
FPS = 60
ANIM_TIME_STEP = 1.0 / FPS

# アニメーションID
class ANIM_ID(IntEnum):
    ANIM_IDLE = 0                        # goku-ssj_BouncingFightIdle.fbx
    ANIM_SHORT_STEP_FORWARD = auto()     # goku-ssj_Short_StepForward.fbx
    ANIM_SHORT_STEP_BACKWARD = auto()    # goku-ssj_Short_StepBackward.fbx
    ANIM_PUNCH = auto()                  # goku-ssj_Punching.fbx
    ANIM_HOOK = auto()                   # goku-ssj_Hook.fbx
    ANIM_KICK = auto()                   # goku-ssj_MmaKick.fbx
    ANIM_LOW_KICK = auto()               # goku-ssj_MmaLowKick.fbx
    ANIM_LEG_SWEEP = auto()              # goku-ssj_LegSweep.fbx
    ANIM_BLOCK = auto()                  # goku-ssj_CenterBlock.fbx
    ANIM_LIGHT_HIT_TO_HEAD = auto()      # goku-ssj_LightHitToHead.fbx
    ANIM_STOMACH_HIT = auto()            # goku-ssj_StomachHit.fbx
    ANIM_FALLING_BACK_DEATH = auto()     # goku-ssj_FallingBackDeath.fbx
