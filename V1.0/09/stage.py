...
FRONT = "../src/data/image/negz.jpg"
BACK = "../src/data/image/posz.jpg"
TOP = "../src/data/image/posy.jpg"
BOTTOM = "../src/data/image/negy.jpg"
LEFT = "../src/data/image/negx.jpg"
RIGHT = "../src/data/image/posx.jpg"
# 床
floor_sp = None
floor_vao = None
floor_texture = None
FLOOR = "../src/data/image/floor.jpg"
view_mat = glm.mat4()
proj_mat = glm.mat4()
